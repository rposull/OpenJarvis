...
def main(
    ...
    prompt = (
        ...
        f"**Garage / addition**: use catalog `garage built all-in` or `addition built all-in` "
        "— priced from component sums (framing, roof, siding, windows, subs) and "
        "**higher $/sqft than deck**. cost_lookup required; never use deck $/sqft.\n"
