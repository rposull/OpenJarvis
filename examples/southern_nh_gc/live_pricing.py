...
def pricing_summary(overrides: dict[str, Any] | None = None) -> dict[str, float]:
    ...
    return {
        ...
        "garage_material_floor_sqft": garage_mat,
        "garage_labor_floor_sqft": garage_lab,
        "garage_material_customer_sqft": customer_price(garage_mat),
        "garage_labor_customer_sqft": customer_price(garage_lab),
        "garage_floor_sqft": garage_floor,
        "garage_customer_sqft": customer_price(garage_floor),
        "addition_material_floor_sqft": add_mat,
        "addition_labor_floor_sqft": add_lab,
        "addition_material_customer_sqft": customer_price(add_mat),
        "addition_labor_customer_sqft": customer_price(add_lab),
